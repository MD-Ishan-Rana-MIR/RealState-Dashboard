...
const RevenueChart = () => {
  const ChartData: any = {
    ...
    markers: {
      strokeColor: [
        "var(--color-error)",     // Match 2023 line
        "var(--color-secondary)", // Match 2022 line
        "var(--color-primary)",   // Match 2024 line
      ],
      strokeWidth: 2,
    },
    tooltip: { theme: "dark" },
  ...
  return (
    <div>
      <div className="pb-0 w-full bg-white shadow p-8 rounded-2xl  ">
